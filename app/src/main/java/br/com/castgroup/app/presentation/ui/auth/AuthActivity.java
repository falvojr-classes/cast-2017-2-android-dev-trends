package br.com.castgroup.app.presentation.ui.auth;
...
import br.com.castgroup.app.presentation.base.BaseActivity;
import br.com.castgroup.app.presentation.helper.AppHelper;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.actionCall:
                final String normalNumber = "+55 16 99602-4082";
